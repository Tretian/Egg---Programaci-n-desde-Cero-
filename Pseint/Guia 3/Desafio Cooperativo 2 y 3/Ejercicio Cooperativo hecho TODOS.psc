Algoritmo Encuentro11_ej1
	...
	Mientras num <1 o num >20
		Escribir "El numero " ,num, " es invalido. Ingrese un número válido (entre 1 y 20)"
		Leer num
	FinMientras
	leer num2
	Mientras num2 <1 o num2 >20
		Escribir "El numero " ,num2, " es invalido. Ingrese un número válido (entre 1 y 20)"
		Leer num2
	FinMientras
	leer num3
	Mientras num3 <1 o num3 >20
		Escribir "El numero " ,num3, " es invalido. Ingrese un número válido (entre 1 y 20)"
		Leer num3
	FinMientras
	leer num4
	Mientras num4 <1 o num4 >20
		Escribir "El numero " ,num4, " es invalido. Ingrese un número válido (entre 1 y 20)"
		Leer num4
	FinMientras
	leer num5
	Mientras num5 <1 o num5 >20
		Escribir "El numero " ,num5, " es invalido. Ingrese un número válido (entre 1 y 20)"
		Leer num5
	FinMientras
